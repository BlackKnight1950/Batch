...
// Never let a browser or proxy cache the HTML. A stale index.html served from
// cache silently runs old code long after a deploy, which is impossible to
// diagnose from the outside. Static assets are still cached normally.
